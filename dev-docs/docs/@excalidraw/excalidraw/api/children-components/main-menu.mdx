    ...
    <div style={{ height: "500px" }}>
      <Excalidraw>
        <MainMenu>
          ...
          <MainMenu.ItemLink href="https://draw.mianmuneebajaz.com">
            Excalidraw
          </MainMenu.ItemLink>
        </MainMenu>
      </Excalidraw>
...
For the items which are shown in the menu in [excalidraw.com](https://draw.mianmuneebajaz.com), you can use `MainMenu.DefaultItems`
