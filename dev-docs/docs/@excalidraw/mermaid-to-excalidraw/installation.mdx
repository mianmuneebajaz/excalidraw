...
`@excalidraw/mermaid-to-excalidraw` is published to npm. This library is used in [excalidraw](https://draw.mianmuneebajaz.com) to transform mermaid syntax to Excalidraw diagrams.
